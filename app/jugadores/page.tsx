  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <main>
        ...
        {/* StoryBrand Section - Transformation Story */}
        <section className="py-32 px-6 bg-black relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-display">
                De jugador frustrado a leyenda de la cancha
              </h2>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
              ...
              >
                ...
                <div className="relative bg-gray-900/50 backdrop-blur-sm border border-red-500/30 rounded-3xl p-8">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4 font-display">
                    El Villano que Te Frena
                  </h3>
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Los métodos tradicionales te mienten. Niveles inventados, consejos genéricos, progreso invisible. 
                    Por eso el <span className="text-red-400 font-bold">87% de jugadores nunca mejora realmente</span>.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative bg-gray-900/50 backdrop-blur-sm border border-[#E3FD72]/30 rounded-3xl p-8">
                  ...
                  <p className="text-gray-300 text-lg leading-relaxed">
                    Imagínate entrando a la cancha con confianza absoluta. Sabiendo exactamente dónde poner cada pelota. 
                    Viendo la cara de tus rivales cuando no pueden regresar tus golpes. 
                    <span className="text-[#E3FD72] font-bold block mt-2">Ese eres tú en 30 días.</span>
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            >
              <p className="text-xl text-gray-400 mb-8">
                Empezá tu transformación ahora. Descarga gratis y descubre tu verdadero nivel.
              </p>
